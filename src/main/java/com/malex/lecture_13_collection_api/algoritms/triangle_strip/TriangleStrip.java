...
import com.malex.lecture_4_algorithms.numbers.remove_consecutive_duplicates.RemoveConsecutiveDuplicates;
...
public class TriangleStrip {
  ...
  private static RemoveConsecutiveDuplicates removeConsecutiveDuplicates =
      new RemoveConsecutiveDuplicates();
  ...
  public static void main(String[] args) {
    ...
    ArrayList<Integer> positionVertexList =
        Lists.newArrayList(
            16, 5, 17, 8, 8, 1, 1, 18, 3, 19, 19, 7, 7, 20, 1, 18, 18, 20, 20, 7, 16, 5, 5, 11, 11,
            21, 8, 17, 17, 21, 21, 11, 19, 3, 3, 3);
    ...
    realPositionBottom =
        removeConsecutiveDuplicates.excludeConsecutiveDuplicates(realPositionBottom);
  ...
  private static class TriangleVertex {
    ...
    boolean isIntersect(TriangleVertex triangle) {
      if (Sets.difference(
                  ...
                  Sets.newHashSet(triangle.p1, triangle.p2, triangle.p3))
              .size()
          == 1) {
        int temp;
