...
public class AbstractThreadSample {
    ...
    protected static void print(Object... logs) {
        String collect = Arrays.stream(logs)
                .map(l -> {
    ...
    protected static void javaStatistic() {
        ...
        print("Total amount of memory in Java virtual machine in bytes:", totalMemory, ", or", convertToMbs(totalMemory), "Mbs");

        long freeMemory = Runtime.getRuntime().freeMemory();
        print("Amount of free memory in Java Virtual Machine in bytes:", freeMemory, ", or", convertToMbs(freeMemory), "Mbs");

        long maxMemory = Runtime.getRuntime().maxMemory();
        print("Maximum amount of memory that Java virtual machine will attempt to use in bytes:", maxMemory, ", or", convertToMbs(maxMemory), "Mbs");
    }
