...
public class AppRun
{
    ...
    {
        GenericType<Int32> genericTypeInt32 = new GenericType<>(new Int32[]{new Int32(1), new Int32(2), new Int32(3)});
        double averageInt32 = genericTypeInt32.average();
        System.out.println(String.format(STRING_FORMAT, "averageInt32", averageInt32));

        GenericType<Double32> genericTypeDouble32 = new GenericType<>(new Double32[]{new Double32(1.0), new Double32(2.0), new Double32(3.0)});
        double averageDouble32 = genericTypeDouble32.average();
        System.out.println(String.format(STRING_FORMAT, "averageDouble32", averageDouble32));
