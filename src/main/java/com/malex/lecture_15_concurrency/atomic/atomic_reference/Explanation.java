...
*
* The catch is, for AtomicReferences, this doesn't use .equals() call, but instead an == comparison for the expected value.
* So make sure the expected is the actual object returned from get in the loop.
*/
public class Explanation extends AbstractUtils {


    @Test
    public void testOldMonitor(){
